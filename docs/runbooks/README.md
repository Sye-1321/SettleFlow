...
| [CI and security gate failure](ci-security-gate-failure.md)                       | Required quality, migration, race, security, image, or supply-chain evidence fails; diagnose without retry-to-green, threshold weakening, or secret exposure.                          | Implemented |
| [Database recovery](database-recovery.md)                                         | Restore exercise or loss event; restore an isolated logical backup, apply migrations, validate INV-01 through INV-10 and evidence relationships, and report measured RPO/RTO honestly. | Implemented |
| [Incident response](incident-response.md)                                         | Security, financial-integrity, recovery, availability, or supply-chain event; contain safely, preserve evidence, validate recovery, and record owner stop/go.                          | Implemented |
