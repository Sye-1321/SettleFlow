...
- [ ] Prisma schema, migration, constraints, indexes, and runtime grants implemented.
- [ ] Eventing inbox and strict consumer contract implemented.
- [ ] Webhooks marker and initial delivery projection implemented.
- [ ] RabbitMQ consumer lifecycle/readiness implemented without topology drift.
- [ ] Unit, migration, PostgreSQL/RabbitMQ, concurrency, and failure scenarios pass.
- [ ] Security, tenant-isolation, least-privilege, and sensitive-data review pass.
- [ ] Existing Payment Intent, endpoint, audit, readiness, and relay regressions pass.
...
| Implementation verification matrix                  | Not run | Required during implementation; no code/schema/dependency/test/runtime command is authorized by this documentation-only task                |
